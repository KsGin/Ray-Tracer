...
int main() {
    ...
    models.push_back(new Plane(Vector3(0, 1, 0), 0, 0, Color::white()));
    models.push_back(new Plane(Vector3(0, 0, -1), -10, 0, Color::white()));
    models.push_back(new Plane(Vector3(1, 0, 0), -10, 0, Color::white()));
    models.push_back(new Plane(Vector3(-1, 0, 0), -10, 0, Color::white()));
